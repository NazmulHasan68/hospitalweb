...
import Admin_Dashboard from "./pages/Admin pages/admin_control_page/Admin_Dashboard";
import DoctorLayout from "./pages/Doctor pages/DoctorLayout";
import Doctor_patient from "./pages/Doctor pages/doctor_control_page/Doctor_patient";
...
import UserLayoutpage from "./pages/User pages/UserLayoutpage";
import Home_page from "./pages/User pages/User_contro_page/Home_page";
import Travel_page_ueser from "./pages/User pages/User_contro_page/travel_user/Travel_page_ueser";
import Medicine_Page_user from "./pages/User pages/User_contro_page/medicine_user/Medicine_Page_user";
import Consultation_user_Layout from "./pages/User pages/User_contro_page/consultation_user/Consultation_user_Layout";
import Medicine_user_Layout from "./pages/User pages/User_contro_page/medicine_user/Medicine_user_Layout";
import Consultation_page_user from "./pages/User pages/User_contro_page/consultation_user/Consultation_page_user";
import Travel_user_layout from "./pages/User pages/User_contro_page/travel_user/Travel_user_layout";
import Medicine_product_details from "./pages/User pages/User_contro_page/medicine_user/Medicine_product_details";
import Travel_Hospital from "./pages/User pages/User_contro_page/travel_user/Travel_Hospital";
import Consultation_video from "./pages/User pages/User_contro_page/consultation_user/Consultation_video";
import Consultation_doctor_search from "./pages/User pages/User_contro_page/consultation_user/Consultation_doctor_search";
import UserControllerLayout from "./pages/User Dashboard/UserControllerLayout";
import UserCost from "./pages/User Dashboard/UserDashoardController/UserCost";
import HelpLine from "./components/Common/HelpLine";
import Consultation_doctor_details from "./pages/User pages/User_contro_page/consultation_user/Consultation_doctor_details";
import Consultation_doctor_info from "./pages/User pages/User_contro_page/consultation_user/Consultation_doctor_info";
import Consultation_doctor_expariance from "./pages/User pages/User_contro_page/consultation_user/Consultation_doctor_expariance";
import Consultation_doctor_education from "./pages/User pages/User_contro_page/consultation_user/Consultation_doctor_education";
