...
export default function Travel_page_ueser() {
   const [dataFromSiblingOne, setDataFromSiblingOne] = useState('');
  return (
    <div className='mt-24'>
      <Travel_Hero_section onSend={(value) => setDataFromSiblingOne(value)}/>
      <Travel_search_hospital receivedData={dataFromSiblingOne}/>
      <Travel_guidline/>
