...
export default function Consultation_sidebar() {
  ...
  const menuItems = [
    ...
    { label: 'Spespalist', icon: <ClipboardList size={20} />, to: '/consultation/spespalist', color: 'text-blue-500' },
    { label: 'New Appointments', icon: <Loader size={20} />, to: '/consultation/appointments', color: 'text-yellow-500' },
    { label: 'Shedule list', icon: <CheckCircle size={20} />, to: '/consultation/shedule', color: 'text-green-500' },
    { label: 'Complete', icon: <CheckCircle size={20} />, to: '/consultation/complete', color: 'text-green-500' },
    { label: 'Rejected', icon: <XCircle size={20} />, to: '/consultation/rejected', color: 'text-red-500' },

    { section: 'System' },
    { label: 'Staff Panel', icon: <Shield size={20} />, to: '/consultation/staff_panel' },
    { label: 'Support List', icon: <Headphones size={20} />, to: '/consultation/support_list' },
  ];
